...
Consegna 17. Repository su GitHub con README.md che spiega cosa hai fatto. 18. Online su GitHub Pages o Netlify.

Docs: Semantic validation html screenshot

Cosa ho approfondito:
-struttura semantica pagina html
-annidamento liste
-utilizzo git e github 
